...
public class PermissionUtils {
    ...
    public static void getLocationPermission2(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
    ...
    public static void getLocationPermission(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            int hasWritePermission = activity.checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION);
